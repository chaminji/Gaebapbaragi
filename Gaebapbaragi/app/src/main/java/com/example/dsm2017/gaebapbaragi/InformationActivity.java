...
public class InformationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        informationArrayList.add(new item("강아지가 삼켜버릴 수 있는 위험한 물건 9가지", "개들이 먹을 수 있는 유익한 음식들을 제외한 음식이나 물건들은, 뭐든지 입으로 넣기 바쁜 우리 댕댕이들에게 언제든지 경고음이 켜질 수 있음을 인지해야 한다.\n\n" +
                "머리끈 – 주인의 냄새가 좋아요\n\n" +
        ...
        informationArrayList.add(new item("강아지 발바닥 털 자주 잘라주어야 하는 이유", "털 때문에 미끄러져 슬개골, 관절에 무리가기도 해\n\n" +
